...
set_property PACKAGE_PIN C7 [get_ports {fp_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {fp_in[0]}]

set_property PACKAGE_PIN C10 [get_ports {fp_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {fp_in[1]}]

set_property PACKAGE_PIN E6 [get_ports {fp_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {fp_in[2]}]

set_property PACKAGE_PIN E7 [get_ports {fp_in[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {fp_in[3]}]


set_property PACKAGE_PIN D6 [get_ports {fp_out[0]}]
...
set_property PACKAGE_PIN E9 [get_ports {fp_out[1]}]
...
set_property PACKAGE_PIN F6 [get_ports {fp_out[2]}]
...
set_property PACKAGE_PIN E8 [get_ports {fp_out[3]}]
...
#sfp RXLOS
set_property PACKAGE_PIN AU5 [get_ports {sfp_rxlos[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sfp_rxlos[0]}]

set_property PACKAGE_PIN AU2 [get_ports {sfp_rxlos[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sfp_rxlos[1]}]

set_property PACKAGE_PIN AV5 [get_ports {sfp_rxlos[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sfp_rxlos[2]}]

set_property PACKAGE_PIN AW3 [get_ports {sfp_rxlos[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sfp_rxlos[3]}]

set_property PACKAGE_PIN AW5 [get_ports {sfp_rxlos[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sfp_rxlos[4]}]

set_property PACKAGE_PIN AW6 [get_ports {sfp_rxlos[5]}]
...
#sfp_leds
#SFP0 LED0
set_property PACKAGE_PIN AU4 [get_ports {sfp_led[0]}]
...
#SFP0 LED1
set_property PACKAGE_PIN AT7 [get_ports {sfp_led[1]}]
...
#SFP1 LED0
set_property PACKAGE_PIN AU1 [get_ports {sfp_led[2]}]
...
#SFP1 LED1
set_property PACKAGE_PIN AU3 [get_ports {sfp_led[3]}]
...
#SFP2 LED0
set_property PACKAGE_PIN AU8 [get_ports {sfp_led[4]}]
...
#SFP2 LED1
set_property PACKAGE_PIN AT6 [get_ports {sfp_led[5]}]
...
#SFP3 LED0
set_property PACKAGE_PIN AV8 [get_ports {sfp_led[6]}]
...
#SFP3 LED1
set_property PACKAGE_PIN AT5 [get_ports {sfp_led[7]}]
...
#SFP4 LED0
set_property PACKAGE_PIN AV3 [get_ports {sfp_led[8]}]
...
#SFP4 LED1
set_property PACKAGE_PIN AV2 [get_ports {sfp_led[9]}]
...
#SFP5 LED0
set_property PACKAGE_PIN AW4 [get_ports {sfp_led[10]}]
...
#SFP5 LED1
set_property PACKAGE_PIN AV6 [get_ports {sfp_led[11]}]
